package com.example.lib_db.utils;
...
public final class StringUtils {
     ...
     * @return
     */
    public static boolean isCharNumberFormat(String string) {
        if (StringUtils.isEmpty(string)) {
            return false;
        }
        String charNumberFormat = "^[A-Za-z0-9]+$";
        return Pattern.matches(charNumberFormat, string);
    }
