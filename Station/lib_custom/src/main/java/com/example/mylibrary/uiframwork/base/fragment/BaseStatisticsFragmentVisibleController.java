...
public class BaseStatisticsFragmentVisibleController {

    private static final boolean DEBUG = false;
    private static final String TAG = "BaseStatisticsFragmentVisibleController";
    ...
    public BaseStatisticsFragmentVisibleController(Fragment fragment, UserVisibleCallback userVisibleCallback) {
