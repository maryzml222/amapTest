package com.zt.station.feature.map.line;
...
public class RouteOverlay {
	...
	protected BitmapDescriptor getStartBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.bus_stop_brand);
	}
	/**
	...
	protected BitmapDescriptor getEndBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.bus_stop_brand_s);
	}
	/**
	...
	protected String addPolyLine(PolylineOptions options) {
		if(options == null) {
			return "";
		}
